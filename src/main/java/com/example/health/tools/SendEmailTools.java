...
public class SendEmailTools {
    ...
    public void sendEmail(String fromEmail, String fromEmailAuthorizationCode, String toEmail, String title, String message) {
        try {
...
//        session.setDebug(true);
            ...
            logger.error("发送邮件给用户--失败，抛出异常 ==== " + toEmail);
